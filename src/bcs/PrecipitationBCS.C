...
//params.addParam<Real>("rate_constant", 1.0, "Value multiplied by the coupled value on the
boundary");
...
params.addParam<MaterialPropertyName>("rate_constant", "k_prcpt", "Temperature dependent
rate constant for precipitation of Cu in Sn");
params.addParam<MaterialPropertyName>("C_svar", "C_sat", "Temperature dependent solubility
of Cu in Sn");
return params;
}
