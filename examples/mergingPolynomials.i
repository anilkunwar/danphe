...
[ICs]
  [./c1_IC]
    ...
    x_positions =  '58.0e3 75.0e3 100.0e3' #'25.0e3 45.0e3 75.0e3'
    ...
    invalue = 1.0
    outvalue = 0.0
    int_width = '4.0e3 4.0e3 4.0e3' #'1.0e3 10.0e3 10.0e3'
    variable = c
  [../]
...
[Materials]
  [./Copper]
    ...
    length_scale = 1.0e-9
    time_scale = 1.0e-3
    D0 = 8.26e-5 #3.275e-4 #8.26e-5   #8.26e-5 # m^2/s, from Brown1980
